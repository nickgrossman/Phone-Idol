...
?>
  ...
  <Play><?php bloginfo('siteurl'); ?>/wp-content/plugins/phoneidol/music_makers.mp3</Play>
  <Say voice="woman">Welcome to Phone Idol!
  </Say>
  <Gather action="<?php bloginfo('siteurl'); ?>/wp-content/plugins/phoneidol/twilio-record.php">
